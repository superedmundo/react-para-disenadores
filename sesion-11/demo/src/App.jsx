...
function App(){return <main className="pagina"><header className="encabezado"><p>Festival Forma</p><h1>La composición cambia con el espacio</h1><p>Reduce el viewport y observa la adaptación.</p></header><section className="galeria">{proyectos.map((proyecto)=><Tarjeta key={proyecto.id} titulo={proyecto.titulo} categoria={proyecto.categoria}/>)}</section></main>}
export default App;
